  ...
  const LARGE_DEVICE_CONTENT = (
    <FlexBox component="nav" sx={LIST_STYLE}>
      ...
      <Box
        component={Link}
        href="/components"
        color={isActive("/components") ? "primary.main" : "white"}
      >
        Components
      </Box>

      <Box component={Link} href="https://essence-doc.vercel.app" color="white">
        Documentation
      </Box>
      ...
      <Drawer anchor="right" open={open} onClose={() => setOpen(false)}>
        <Scrollbar>
          <List disablePadding sx={{ minWidth: 260, height: "100%" }}>
            ...
            <ListItem disablePadding>
              <ListItemButton LinkComponent="a" href="https://essence-doc.vercel.app">
                Documentation
              </ListItemButton>
            </ListItem>
