...
const FromLastMonth: FC<Props> = ({ name, percentage, isPercentage = true, number, string, description, isCurrency }) => {
  return (
    <Card
      sx={{
        padding: 3,
      ...
      <div>
        ...
        <FlexBox alignItems="center" gap={1}>
          <H6>
            ...
            {string ? string : numberFormat(number || 0)}</H6>
          {percentage && <Percentage type={percentage > 0 ? "success" : "error"}>{percentage}{isPercentage && '%'}</Percentage>}
        </FlexBox>
