...
const MuiPopoverPageView = () => {
  ...
  const [transitionEl, setTransitionEl] = useState<HTMLButtonElement | null>(
    null,
  );
  const [trans, setTrans] = useState("z");
  const handleTransClose = () => setTransitionEl(null);
  const handleTransClick =
    (val: string) => (event: MouseEvent<HTMLButtonElement>) => {
              ...
              >
                <Box p={3} maxWidth={400}>
                  ...
                  <Paragraph mt={1}>
                    ...
                    Quisquam odio fugit suscipit iste est beatae vero quia hic
                    explicabo mollitia?
                  </Paragraph>
                </Box>
              </Popover>
          ...
          <Block title="Transition">
            <Stack justifyContent="center" alignItems="center">
              ...
              <Popover
                ...
                anchorOrigin={{ vertical: "bottom", horizontal: "left" }}
                TransitionComponent={
                  trans === "z" ? Zoom : trans === "f" ? Fade : Grow
                }
              >
                <Box p={3} maxWidth={400}>
                  <H6 fontSize={18}>The content of the Popover.</H6>
