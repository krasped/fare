      ...
      <Grid container spacing={3}>
        <Grid item lg={6} xs={12}>
          <Block title="Combo Box">
            <Autocomplete
              ...
              options={top100Films}
              renderInput={(params) => (
                <TextField {...params} size="medium" label="Combo Box" />
              )}
            />
          </Block>
        </Grid>
        ...
        <Grid item lg={6} xs={12}>
          <Block title="Free Solo">
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} size="medium" label="Search" />
              )}
            />
          </Block>
        </Grid>
        ...
        <Grid item lg={6} xs={12}>
          <Block title="Controlled">
            ...
            <Paragraph mt={1}>
              Selected:{" "}
              {selectedCountry ? JSON.stringify(selectedCountry) : null}
            </Paragraph>
          </Block>
        </Grid>
        ...
        <Grid item lg={6} xs={12}>
          <Block title="Multiple values">
            <Autocomplete
              ...
              getOptionLabel={(option) => option.label}
              renderInput={(params) => (
                <TextField {...params} size="medium" label="Tags" />
              )}
            />
          </Block>
        </Grid>
        ...
        <Grid item lg={6} xs={12}>
          <Block title="Creatable values">
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} size="medium" label="Creatable" />
              )}
            />
          </Block>
        </Grid>
