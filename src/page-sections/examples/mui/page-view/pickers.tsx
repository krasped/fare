...
const MuiPickersPageView = () => {
  ...
  const [selectDate, setSelectedDate] = useState<string | null>(
    format(new Date(2023, 1, 5), "dd-MM-yyyy"),
  );
  ...
  return (
    <ComponentPageLayout
      ...
      fullLink="https://mui.com/x/react-date-pickers"
    >
              ...
              <Block title="Static Date" sx={{ mt: 3 }}>
                <Stack spacing={4}>
                  ...
                  <DatePicker
                    ...
                    minDate={new Date("2012-03-01").toDateString()}
            ...
            <Grid item lg={6} xs={12}>
              <Block title="Basic">
                <DateTimePicker
                  ...
                  onChange={(newValue) => setSelectTime(newValue)}
                  renderInput={(params) => (
                    <TextField {...params} size="medium" fullWidth />
                  )}
                />
              </Block>
            </Grid>
