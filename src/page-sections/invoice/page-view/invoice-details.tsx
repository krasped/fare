        ...
        <Grid container spacing={3}>
          <Grid item md={7} xs={12}>
            <FlexBetween>
              <Box width={60}>
                <img
                  src="/static/payment/FedEx_Express.svg"
                  height="36px"
                  alt=""
                />
              </Box>
            ...
            <H6 fontSize={14} mb={1}>
              Issue Date:{" "}
              <Span sx={{ color: "text.secondary", fontWeight: 400 }}>
                03/10/2018
              </Span>
            </H6>
          ...
          <Grid item md={5} xs={12}>
            <StyledBox>
              ...
              <Stack mt={3} spacing={2}>
                ...
                <ListItem
                  text="Account:"
                  description="Nl24IBAN34553477847370033 AMB NLANBZTC"
                />
                <ListItem
                  text="Payment Term:"
                  description="14 Days . Due in 7 days"
                />
              </Stack>
              ...
              <Stack mt={3} spacing={2}>
                ...
                <ListItem
                  text="Time Spent:"
                  description="120 Hours . 20$ / h rate"
                />
              </Stack>
            </StyledBox>
          </Grid>
